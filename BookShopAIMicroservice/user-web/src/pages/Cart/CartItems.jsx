...
// export default function CartItems({ cart, setCart, meta, refreshCart }) {
...
//         x.id === it.id ? { ...x, quantity: nextQty, total: x.price * nextQty } : x
//       ),
//     }));
//     try {
//       setBusy(true);
...
//         {cart.items.map((it) => (
//           <Box key={it.id} display="grid" gridTemplateColumns="90px 1fr 140px 40px" gap={2} mb={2}>
//             <img
//               src={it.bookImage}
//               alt={it.bookTitle}
...
//               </Typography>
//               <Chip size="small" label={`Số lượng: ${it.quantity}`} />
...
//             </Typography>
//             <IconButton color="error" disabled={busy} onClick={() => removeLine(it)}>
//               <DeleteOutline />
//             </IconButton>
//           </Box>
//         ))}
