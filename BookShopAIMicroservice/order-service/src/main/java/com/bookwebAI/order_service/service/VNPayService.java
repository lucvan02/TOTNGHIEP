...
public class VNPayService {
    ...
    public String createPaymentUrl(String orderId, int amountVnd) {
        ...
        // theo mẫu VNPay: dùng txnRef ngẫu nhiên, orderInfo mô tả
        String vnpTxnRef = String.valueOf(System.currentTimeMillis());
        String vnpOrderInfo = "Thanh toan don hang:" + orderId; // TRÁNH dùng ký tự '#'
        ...
        params.put("vnp_Amount", String.valueOf(amountVnd * 100)); // nhân 100
        ...
        // ❗ Theo mẫu VNPay (ajaxServlet.java): hashData DÙNG GIÁ TRỊ ĐÃ URL-ENCODE
