...
# COLLECTION_NAME = "general_knowledge" # Tên collection mới cho cả sách và file

# # ---------- CẤU HÌNH DỮ LIỆU FILE ----------
# # Thư mục chứa các file văn bản (chính sách, FAQ,...)
# FILE_DATA_DIR = BASE_DIR / "data" / "policy"

# # ---------- CẤU HÌNH MYSQL (Giữ nguyên) ----------
...
#     metadata = {
#         "source": "mysql_book", # Thêm metadata để nhận diện nguồn
#         "book_id": row["id"],
#         "title": title,
#         "authors": authors,
...
#     # Loader cho các file .txt và .md
#     generic_loader = DirectoryLoader(
#         path=str(data_dir), 
#         glob="**/*.txt", 
#         silent_errors=True
#     )
...
#         path=str(data_dir), 
#         glob="**/*.pdf",
#         loader_cls=PyPDFLoader, # Sử dụng PyPDFLoader cho file PDF
#         silent_errors=True
#     )

#     documents = generic_loader.load() + pdf_loader.load()
    
#     if not documents:
#         print("Không tìm thấy file nào trong thư mục policy.")
#         return []

#     # Chia nhỏ văn bản lớn thành các chunk nhỏ hơn để nhúng hiệu quả
...
#     # Gán source cho từng chunk
#     docs_with_metadata = []
#     for doc in documents:
#         # Chuẩn hóa đường dẫn file trong metadata
#         doc.metadata["source"] = "file_policy" # Thêm metadata nhận diện nguồn
...
#         return None # Trả về None nếu không có gì để nhúng
...
#     print(f"Đang tạo vectorstore Chroma (LOCAL) với tổng cộng {len(all_docs)} chunks...")
...
#     print(
#         f"Ingest xong toàn bộ dữ liệu vào Chroma tại '{PERSIST_DIR}', "
#         f"collection='{COLLECTION_NAME}'"
#     )
#     return new_vectorstore # Trả về vectorstore mới
...
def run_ingestion():
    ...
    # Xóa vector DB cũ để tạo lại cho sạch (Nếu bị lỗi khóa file, phải xóa thủ công)
    shutil.rmtree(PERSIST_DIR, ignore_errors=True)
