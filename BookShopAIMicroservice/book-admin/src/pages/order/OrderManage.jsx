...
// const [cancelModal, setCancelModal] = useState({ open: false, order: null, reasonType: "OUT_OF_STOCK", other: "" });

// const openCancelModal = (order) => setCancelModal({ open: true, order, reasonType: "OUT_OF_STOCK", other: "" });
// const closeCancelModal = () => setCancelModal({ open: false, order: null, reasonType: "OUT_OF_STOCK", other: "" });
...
//   };
//   const reason = reasonType === "OTHER" ? reasonMap.OTHER : reasonMap[reasonType];
...
//     const res = await adminOrderApi.detail(order.id);
...
// src/pages/order/OrderManage.jsx
import { useEffect, useMemo, useState } from "react";
import {
  Table,
  Tag,
