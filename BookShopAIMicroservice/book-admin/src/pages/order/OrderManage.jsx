...
//                 {drawer.order.status === "PENDING" ? "CHỜ XÁC NHẬN" : drawer.order.status === "CONFIRM" ? "ĐÃ XÁC NHẬN" : drawer.order.status === "SHIPPED" ? "ĐANG GIAO" : drawer.order.status === "COMPLETED" ? "ĐÃ HOÀN TẤT" : "ĐÃ HỦY"}
//               </Tag>
...
//               {/* {drawer.order.confirmedAt && <Tag>Xác nhận: {fmtDt(drawer.order.confirmedAt)}</Tag>}
//               {drawer.order.shippedAt && <Tag>Giao hàng: {fmtDt(drawer.order.shippedAt)}</Tag>}
//               {drawer.order.completedAt && <Tag>Hoàn tất: {fmtDt(drawer.order.completedAt)}</Tag>}
//               {drawer.order.cancelledAt && <Tag>Hủy: {fmtDt(drawer.order.cancelledAt)}</Tag>} */}
//             </Space>
...
/* ================= helpers ================= */
// Mã trạng thái BE (code) -> Nhãn tiếng Việt
const STATUS_LABEL = {
